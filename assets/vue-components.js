...
if ($('#vue-collection').length) {
    ...
    var vueCollection = new Vue({
        ...
        methods: {
            ...
            isFilteredProduct: function isFilteredProduct(product) {
                var includesAllColors = false;
                var includesAllSizes = true;
            ...
            productAvailable: function productAvailable(product) {
            ...
            compareAtPrice: function compareAtPrice(product) {
                var compareAtPrice = void 0;
            ...
            productPrice: function productPrice(product) {
                return product.variants[0].price;
            },
            toggleSizeFilter: function toggleSizeFilter(filter) {
                // remove if already set
                if (this.sizeFilters.includes(filter)) {
                    var index = this.sizeFilters.indexOf(filter);
            ...
            toggleColorFilter: function toggleColorFilter(filter) {
                // remove if already set
                if (this.colorFilters.includes(filter)) {
                    var index = this.colorFilters.indexOf(filter);
            ...
            isActiveFilter: function isActiveFilter(filterType, filter) {
                var filterTypeToCheck = filterType + 'Filters';
            ...
            setGridLayout: function setGridLayout(viewType) {
            ...
            descendingSort: function descendingSort(array) {
                var clonedArray = array.slice(0);
            ...
            originalSort: function originalSort(array) {
                var clonedArray = array.slice(0);
