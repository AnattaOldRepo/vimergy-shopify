var _carbonads = {
	init: function (where, force_serve) {
		...
		reroute['startbootstrapcom'] = 'CVYD42T';
		reroute['jessepollak'] = 'C6AILKT';
...
function _carbonads_go(b) {
	...
	image = ad.image.startsWith('//') ? (protocol + ad.image) : ad.image;
	...
	el.innerHTML = '<span class="carbon-wrap"><a href="' + fulllink.replace('[timestamp]', time) + '" class="carbon-img" target="_blank" rel="noopener"><img src="' + image + '" alt="" border="0" height="100" width="130" /></a><a href="' + fulllink.replace('[timestamp]', time) + '" class="carbon-text" target="_blank" rel="noopener">' + ad.description + '</a></span>';
