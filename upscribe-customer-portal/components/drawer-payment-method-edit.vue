...
export default {
  ...
  methods: {
    ...
    async updatePaymentMethod(updatePaymentData) {
...
<template>
  <!-- <drawer-wrap v-if="activeEditCard" :show="show" @close="$emit('close')"> -->
    <div v-if="activeEditCard" class="c-drawer c-drawerEditCard" :class="{'c-drawer--paddingDefault': !editNextOrder}">
      <div class="c-drawer__inner">
          <h2 class="c-drawer__title">{{ atc['portal.editCardDrawerTitle'] || 'Edit Payment Method' }}</h2>
