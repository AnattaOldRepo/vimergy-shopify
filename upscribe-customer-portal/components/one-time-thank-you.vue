<template>
  <div v-if="otoProduct && otoVariant && activeSubscription">
    <section class="c-oneTimeThankYou">
      <div class="c-oneTimeThankYou__inner">
        <div class="c-oneTimeThankYou__top">
          <div class="c-oneTimeThankYou__logoWrap">
          ...
          <p class="c-orderThankyou__message">
            {{ otoProduct.title }} ({{ otoVariant.title }}) {{ atc['portal.oneTimeOrderThankYouMessage'] || 'is added to your next order shipping on'}} {{ nextShipDate }}.
          </p>
        </div>

        <div class="c-oneTimeThankYou__bottom">
          <div class="c-oneTimeThankYou__items">
            <product-option
              v-for="item in activeSubscription.next.items"
              :key="item.id"
              :product="item"
              :show-price="true"
              class="c-oneTimeThankYou__item"
            />
          </div>

          <div class="c-oneTimeThankYou__total c-tableContainer">
            <table class="c-table">
              <tbody>
                <tr>
...
// https://cp-stage.upscribe.io/?storeDomain=upscribe-demo.myshopify.com&customerId=1051286306867&otoProductVariantId= 17248327139379&otoQueueId=67&otoSubscriptionId=70
...
.c-oneTimeThankYou__inner {
  width: 100%;
  max-width: 786px;
}

.c-oneTimeThankYou__top {
  display: flex;
...
.c-oneTimeThankYou__logoWrap {
  margin-bottom: 40px;
}

.c-oneTimeThankYou__logo {
  margin-bottom: 22px;
}
