<template>
	<div>
		...
		<div class="c-reactivateSubscriptionByLink">
			...
			<div v-else class="c-reactivateSubscriptionByLink__loading">
				<h2 class="c-reactivateSubscriptionByLink__loadingText">{{
					atc['portal.reactivateSubscriptionByLinkLoadingMessage'] ||
						'Reactivating Subscription'
				}}</h2>
				<second-loader-icon class="c-reactivateSubscriptionByLink__loadingIcon" />
			</div>
		</div>
	</div>
</template>
